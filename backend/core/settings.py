...
SECRET_KEY = 'django-insecure-^0t*y@_qs1%u)m)%$_-_ri-)=^pn+z2b3u-1tlux=lxzr*12$b'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://neondb_owner:npg_RhzrEC8VGY6s@ep-aged-shadow-anxn524s.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require',
        conn_max_age=600,
